...
26. создать уч запись; доступ к устройству SELECTED; роль - оператор системы; выбираем одно устройство при создании пользователя; заходим в учётку; переходим в данные с устройств - сайт ложится(ошибка с УЛК404, с УЛК705 нет).
